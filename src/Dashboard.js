    ...
    return (
      <ChartContainer className="dv-dashboard">
        <nav className="dv-dashboard__column dv-dashboard__column--nav">
          <h2 className="dv-dashboard__nav-title">{this.meta.dashboard_title}</h2>
          {/* <h4 className="dv-dashboard__nav-heading">{this.findings_heading}</h4> */}
          <ButtonGroup
          ...
          />
          <h4 className="dv-dashboard__nav-heading">{this.filter_heading}</h4>
          <ButtonGroup
            onChange={this.handleFilterDemographicChange}
            options={this.props.data.demographic_keys.filter(d => !d.skip_demographic_key).map(d => ({ id: d.demographic_key, text: d.demographic_key }))}
            active={this.props.data.demographic_keys.filter(d => !d.skip_demographic_key)[0].demographic_key}
